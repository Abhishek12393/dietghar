...
var DatatableScroller = function() {
    ...
    var _componentDatatableScroller = function() {
        if (!$().DataTable) {
            console.warn('Warning - http://dietsoftware.tk/diet/admin/global_assets/js/plugins/tables/datatables/datatables.min.js is not loaded.');
            return;
        }
        ...
        $.extend( $.fn.dataTable.defaults, {
            ...
            ajax: 'http://dietsoftware.tk/diet/admin/global_assets/demo_data/tables/datatable_2500.json',
            deferRender: true,
            scrollY: 419,
            scrollCollapse: true,
            language: {
    ...
    var _componentSelect2 = function() {
        if (!$().select2) {
            console.warn('Warning - http://dietsoftware.tk/diet/admin/global_assets/js/plugins/forms/selects/select2.min.js is not loaded.');
            return;
        }
