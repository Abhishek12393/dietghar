...
var TagInputs = function() {
    ...
    var _componentTagsinput = function() {
        ...
        var citynames = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: {
                url: 'https://dietghar.in/diet/admin/global_assets/demo_data/tags_input/citynames.json',
        ...
        var countries = new Bloodhound({
            ...
            limit: 10,
            prefetch: {
                url: 'https://dietghar.in/diet/admin/global_assets/demo_data/tags_input/cities.json'
            }
        });
