! function(t, e) {
    ...
    e.locale("en"), t.fn[a] = function(e, a) { return this.each(function() { t.data(this, s) ? ("function" == typeof t.data(this, s)[e] && t.data(this, s)[e](a), "destroy" === e && delete t.data(this, s)) : t.data(this, s, new i(this, e)) }), this }, i.prototype = { init: function() { this.initDays(), this.initDates(), this.initTemplate(), this.initButtons(), this._attachEvent(t(window), "resize", this._centerBox.bind(this)), this._attachEvent(this.$dtpElement.find(".dtp-content"), "click", this._onElementClick.bind(this)), this._attachEvent(this.$dtpElement, "click", this._onBackgroundClick.bind(this)), this._attachEvent(this.$dtpElement.find(".dtp-close > a"), "click", this._onCloseClick.bind(this)), this._attachEvent(this.$element, "focus", this._onFocus.bind(this)) }, initDays: function() { this.days = []; for (var t = this.params.weekStart; this.days.length < 7; t++) t > 6 && (t = 0), this.days.push(t.toString()) }, initDates: function() { if (this.$element.val().length > 0) "undefined" != typeof this.params.format && null !== this.params.format ? this.currentDate = e(this.$element.val(), this.params.format).locale(this.params.lang) : this.currentDate = e(this.$element.val()).locale(this.params.lang);
                ...
                else if ("undefined" == typeof this.params.currentDate.isValid || "function" != typeof this.params.currentDate.isValid) { var t = this.params.currentDate.getTime();
                    this.currentDate = e(t, "x").locale(this.params.lang) } else this.currentDate = this.params.currentDate;
                this.$element.val(this.currentDate.format(this.params.format)) } else this.currentDate = e(); if ("undefined" != typeof this.params.minDate && null !== this.params.minDate)
                ...
                else if ("undefined" == typeof this.params.minDate.isValid || "function" != typeof this.params.minDate.isValid) { var t = this.params.minDate.getTime();
                this.minDate = e(t, "x").locale(this.params.lang) } else this.minDate = this.params.minDate;
            else null === this.params.minDate && (this.minDate = null); if ("undefined" != typeof this.params.maxDate && null !== this.params.maxDate)
            ...
            this._centerBox(), this.showDate(e) }, initHours: function() { this.currentView = 1, this.showTime(this.currentDate), this.initMeridienButtons(), this.currentDate.hour() < 12 ? this.$dtpElement.find("a.dtp-meridien-am").click() : this.$dtpElement.find("a.dtp-meridien-pm").click(); var t = this.params.shortTime ? "h" : "H";
            this.$dtpElement.find(".dtp-picker-datetime").removeClass("hidden"), this.$dtpElement.find(".dtp-picker-calendar").addClass("hidden"); for (var e = this.createSVGClock(!0), i = 0; 12 > i; i++) { var a = -(162 * Math.sin(2 * -Math.PI * (i / 12))),
                    s = -(162 * Math.cos(2 * -Math.PI * (i / 12))),
                    n = this.currentDate.format(t) == i ? "#8BC34A" : "transparent",
                    r = this.currentDate.format(t) == i ? "#fff" : "#000",
                    h = this.createSVGElement("circle", { id: "h-" + i, "class": "dtp-select-hour", style: "cursor:pointer", r: "30", cx: a, cy: s, fill: n, "data-hour": i }),
                    d = this.createSVGElement("text", { id: "th-" + i, "class": "dtp-select-hour-text", "text-anchor": "middle", style: "cursor:pointer", "font-weight": "bold", "font-size": "20", x: a, y: s + 7, fill: r, "data-hour": i });
                d.textContent = 0 === i && this.params.shortTime ? 12 : i, this.toggleTime(i, !0) ? (h.addEventListener("click", this._onSelectHour.bind(this)), d.addEventListener("click", this._onSelectHour.bind(this))) : (h.className += " disabled", d.className += " disabled", d.setAttribute("fill", "#bdbdbd")), e.appendChild(h), e.appendChild(d) } if (!this.params.shortTime) { for (var i = 0; 12 > i; i++) { var a = -(110 * Math.sin(2 * -Math.PI * (i / 12))),
                        s = -(110 * Math.cos(2 * -Math.PI * (i / 12))),
                        n = this.currentDate.format(t) == i + 12 ? "#8BC34A" : "transparent",
                        r = this.currentDate.format(t) == i + 12 ? "#fff" : "#000",
                        h = this.createSVGElement("circle", { id: "h-" + (i + 12), "class": "dtp-select-hour", style: "cursor:pointer", r: "30", cx: a, cy: s, fill: n, "data-hour": i + 12 }),
                        d = this.createSVGElement("text", { id: "th-" + (i + 12), "class": "dtp-select-hour-text", "text-anchor": "middle", style: "cursor:pointer", "font-weight": "bold", "font-size": "22", x: a, y: s + 7, fill: r, "data-hour": i + 12 });
            ...
            this._centerBox() }, initMinutes: function() { this.currentView = 2, this.showTime(this.currentDate), this.initMeridienButtons(), this.currentDate.hour() < 12 ? this.$dtpElement.find("a.dtp-meridien-am").click() : this.$dtpElement.find("a.dtp-meridien-pm").click(), this.$dtpElement.find(".dtp-picker-calendar").addClass("hidden"), this.$dtpElement.find(".dtp-picker-datetime").removeClass("hidden"); for (var t = this.createSVGClock(!1), e = 0; 60 > e; e++) { var i = e % 5 === 0 ? 162 : 158,
                    a = e % 5 === 0 ? 30 : 20,
                    s = -(i * Math.sin(2 * -Math.PI * (e / 60))),
                    n = -(i * Math.cos(2 * -Math.PI * (e / 60))),
                    r = this.currentDate.format("m") == e ? "#8BC34A" : "transparent",
                    h = this.createSVGElement("circle", { id: "m-" + e, "class": "dtp-select-minute", style: "cursor:pointer", r: a, cx: s, cy: n, fill: r, "data-minute": e });
                this.toggleTime(e, !1) ? h.addEventListener("click", this._onSelectMinute.bind(this)) : h.className += " disabled", t.appendChild(h) } for (var e = 0; 60 > e; e++)
                if (e % 5 === 0) { var s = -(162 * Math.sin(2 * -Math.PI * (e / 60))),
                        n = -(162 * Math.cos(2 * -Math.PI * (e / 60))),
                        r = this.currentDate.format("m") == e ? "#fff" : "#000",
                        d = this.createSVGElement("text", { id: "tm-" + e, "class": "dtp-select-minute-text", "text-anchor": "middle", style: "cursor:pointer", "font-weight": "bold", "font-size": "20", x: s, y: n + 7, fill: r, "data-minute": e });
            ...
            this._centerBox() }, animateHands: function() { var t = this.currentDate.hour(),
                e = this.currentDate.minute(),
                i = this.$dtpElement.find(".hour-hand");
            i[0].setAttribute("transform", "rotate(" + 360 * t / 12 + ")"); var a = this.$dtpElement.find(".minute-hand");
            a[0].setAttribute("transform", "rotate(" + 360 * e / 60 + ")") }, createSVGClock: function(t) { var e = this.params.shortTime ? -120 : -90,
