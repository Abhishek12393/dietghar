...
<form id="upload_csv" action="upload.php" method="post" enctype="multipart/form-data"> 
    <table class="table table-bordered"> 
        <tr>
            ...
            <td><input type="submit" name="upload1" id="upload1" value="Upload IGST" style="margin-top:10px;" class="btn btn-primary pull-right" /></td>
        </tr>
        <tr>
            <td style="padding-top:20px;font-weight:bold; ">Import CGST</td>
            <td><input type="file" name="file2" style="margin-top:15px;" /></td>
            <td><input type="submit" name="upload2" id="upload2" value="Upload CGST" style="margin-top:10px;" class="btn btn-success pull-right" /></td>
        </tr>
    </table>    
