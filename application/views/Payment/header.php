...
@media only screen and (max-width: 575px) {#bgbdy {background-image: url('<?php echo base_url(); ?>dgassets/stepper/bg-mob-pay.png'); width:100%; height:100vh; background-repeat: repeat-y;}}
