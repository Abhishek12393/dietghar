   <!--Chat widget-->
    <button id="chat_button" type="button" class="btn open-button"><img src="<?php echo base_url(); ?>user/new_assets/img/chat/questions.png"></i>
     </button>
    ...
    <div class="card zoom-mobile alert alert-dismissible fade show p-0 border-0 shadow-sm position_chat myForm" style="width: 25rem; z-index: 9999;" role="alert" id="chat_widget">
        ...
        <div class="overflow_container">
            <ul class="list-group list-group-flush">
                <li class="list-group-item">You are chatting with
                    <strong>Suport Team</strong>
                </li>
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-2">
                            <img src="<?php echo base_url(); ?>user/new_assets/img/chat/support_img.PNG" alt="" width="50px" height="50px">
                        </div>
                        <div class="col-10">
                            <strong class="danger_team">Support Team</strong>
                            <p>Did You do the exercise?</p>
                        </div>
                    </div>
                </li>
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-2">
                            <img src="<?php echo base_url(); ?>user/new_assets/img/chat/man-2.PNG" alt="" width="50px" height="50px">
                        </div>
                        <div class="col-10">
                            <strong>You</strong>
                            <p>Yes but I have some issues regarding the time</p>
                        </div>
                    </div>
                </li>
                <li class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <strong class="danger_team">Support Team</strong>
                            <p>Yes we would be more than happy to help</p>
                        </div>
                    </div>
                </li>
                <li class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <strong>You</strong>
                            <p>Till what time should I do the exercise and how many reps should I do?</p>
                        </div>
                    </div>
                </li>
                <li class="list-group-item">
    ...
    <script src="<?php echo base_url(); ?>user/new_assets/js/popper.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?>user/new_assets/js/owl.carousel.min.js"></script>
    <script src="<?php echo base_url(); ?>user/new_assets/js/owl-carouselSetting.js"></script>
    <script src="<?php echo base_url(); ?>user/new_assets/js/Chart.min.js"></script>
    <!-- <script src="<?php echo base_url(); ?>user/new_assets/js/chartSetting.js"></script> -->
