...
button.footer_btn {font-weight: 600;color: #58508d;padding: 7px;font-size: 12px;border-radius: 4px;background-color: #ffadd1;}
...
<form method="post" action="<?=base_url('User/submitMeasurement')?>">
<div id="Paris" class="tabcontent-gender" style="display:block;">
<?php $datex = date('Y-m-d'); ?>
<input type="hidden" name="datem" value="<?php echo $datex ?>">
...
<img src="<?php echo base_url(); ?>user/assets/images/MEN/neck_size.png" alt="neck_size" class="media-object-measurements">
</div>
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/chest_size.PNG" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/waist_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
<img src="<?php echo base_url(); ?>user/assets/images/MEN/circle.png" class="circle-woman-img-measuements-235235">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/men_image.png" class="man-img-measuements-235235">
</div>
</div>
<div class="col-md-3">
<div class="side-section-1-measurements">
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/hip_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
<input type="hidden" name="url" value="<?=$routes?>">
<div class="side-section-1-measurements">
<h4 class="media-heading-measurements"> Arm Size </h4> 
<div class="media media-measurements">                        
<div class="media-left">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/arm_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/thigh_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
<img src="<?php echo base_url(); ?>user/assets/images/MEN/Man_Neck.png" style="width: 100%;">
</div>
...
<div class="modal-body">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/Man_Chest.png" style="width: 100%;">
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
</div>
...
<div class="modal-body">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/Man_Waist.png" style="width: 100%;">
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
</div>
...
<div class="modal-body">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/Man_Hip.png" style="width: 100%;">
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
</div>
...
<div class="modal-body">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/Man_Arm.png" style="width: 100%;">
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
</div>
...
<div class="modal-body">
<img src="<?php echo base_url(); ?>user/assets/images/MEN/Man_Thigh.png" style="width: 100%;">
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
</div>
