...
<link rel="stylesheet" href="https://dietghar.in/diet/user/new_assets/css/device-desktop.css?v=53">
<link rel="stylesheet" href="https://dietghar.in/diet/user/new_assets/css/device-ipad.css?v=53">
<link rel="stylesheet" href="https://dietghar.in/diet/user/new_assets/css/device-mobile.css?v=53">

<style type="text/css">
body {background-color: #75a9fc !important;}
...
<link rel="stylesheet" href="https://dietghar.in/diet/user/assets/css/res-style.css">

<div class="content-body">
<div class="container-fluid">
<div class="row">

<section style="background: #75a9fc;background-size: 100% 100%;">
...
<div class="col-md-6">
<h1 style="text-align: center;"> Measurements </h1>
<p style="text-align: center;"> <span> Note: </span> please provide accurate information for best results </p>
</div>
<div class="col-md-3"></div>
</div> 
</main>
...
<form method="post" action="https://dietghar.in/diet/User/submitMeasurement">
...
<img src="https://dietghar.in/diet/user/assets/images/MEN/neck_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
<input type="number" name="weight" onkeypress="javascript:return isNumber(event)" class="input-number-nexk-size" min="30" max="160" step="00" pattern="^\d+(?:\.\d{2,1})?$" onblur="
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{2,1})?$/.test(this.value)?'inherit':'red'" autocomplete="off" placeholder="00 kg" required="" tabindex="1">
</div>
</div>
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/neck_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{2,1})?$/.test(this.value)?'inherit':'red'" autocomplete="off" placeholder="00.0 inches" required="" tabindex="3">
</div>
</div>
<a href="#" data-toggle="modal" data-target="#view-full-images" class="tag-view-full-images-mes measure-top"> How to Measure </a>
</div>
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/chest_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{2,1})?$/.test(this.value)?'inherit':'red'" autocomplete="off" placeholder="00.0 inches" required="" tabindex="5">
</div>
</div>
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/waist_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{2,1})?$/.test(this.value)?'inherit':'red'" autocomplete="off" placeholder="00.0 inches" required="" tabindex="7">
</div>
</div>
...
<img src="https://dietghar.in/diet/user/assets/images/MEN/circle.png" class="circle-woman-img-measuements-235235">
<img src="https://dietghar.in/diet/user/assets/images/MEN/men_image.png" class="man-img-measuements-235235">
</div>
</div>
<div class="col-md-3">
<div class="side-section-1-measurements">
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/hip_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{2,1})?$/.test(this.value)?'inherit':'red'" autocomplete="off" placeholder="00.0 inches" required="" tabindex="2">
</div>
</div>
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/arm_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{2,1})?$/.test(this.value)?'inherit':'red'" autocomplete="off" placeholder="00.0 inches" required="" tabindex="4">
</div>
</div>
...
<div class="media media-measurements">                        
<div class="media-left">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/thing_size.png" alt="neck_size" class="media-object-measurements">
</div>
<div class="media-body">                                                   
...
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{2,1})?$/.test(this.value)?'inherit':'red'" autocomplete="off" placeholder="00.0 inches" required="" tabindex="6">
</div>
</div>
...
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/Woman_Neck.png" style="width: 100%;">
</div>
...
<div class="modal-body">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/Woman_Chest.png" style="width: 100%;">
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
</div>
...
<div class="modal-body">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/Woman_Waist.png" style="width: 100%;">
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
</div>
...
<div class="modal-body"><img src="https://dietghar.in/diet/user/assets/images/WOMAN/Woman_Hip.png" style="width: 100%;"></div>
...
<div class="modal-body">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/Woman_Arm.png" style="width: 100%;">
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
</div>
...
<div class="modal-body">
<img src="https://dietghar.in/diet/user/assets/images/WOMAN/Woman_Thigh.png" style="width: 100%;">
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
</div>
...
<script src="https://dietghar.in/diet/user/assets/images/WOMAN/jquery-3.js"></script>
<script src="https://dietghar.in/diet/user/assets/images/WOMAN/bootstrap.js"></script>
