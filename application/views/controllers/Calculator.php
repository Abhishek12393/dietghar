...
class Calculator extends CI_Controller {
    ...
    public function Bmi(){
        ...
        $weightkg = 11; //input
        echo $Bmi = $weightkg / ($heightm * $heightm);
    ...
    public function Bmr(){
        ...
        $age = 27; //input
        if($gender == 'Male'){
        echo  $BMR = 66 + ( 13.7 * $weightkg ) + ( 5 * $heightcm ) - ( 6.8 * $age);
        }elseif($gender == 'Female'){
        echo 	$BMR = 655 + ( 9.6 * $weightkg ) + ( 1.8 * $heightcm ) - ( 4.7 * $age );
        }
    }
