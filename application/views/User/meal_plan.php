...
<div class="card-header">
  <h4 class="card-title text-center">Meal Plan</h4>
   <span><img src="https://dietghar.com/diet/dgassets/user/icons/icon-gilas.png" width="24" class="text-right"> = 1 Glass Water</span><br><span><img src="https://dietghar.com/diet/dgassets/user/icons/icon-salad.png" width="24"> = 1 Salad Plate</span>
</div>
<div class="card-body">
...
<?php elseif($plan_stat == 0 || $plan_stat == 3): ?>
<center>
<div class="mt-4">
...
<td> <center><mark><?=date('h:i A',strtotime($midmealtime)-900); ?></mark></center></td>
...
<td><center><mark><?=date('h:i A',strtotime($lunchtime)-1800); ?></mark></center> </td>
...
<td><center><mark><?=date('h:i A',strtotime($eveningtime)-1800); ?></mark></center> </td>
...
<td> <center><mark><?=date('h:i A',strtotime($dinnertime)-1800); ?></mark></center></td>
...
<td> <center><mark><?=date('h:i A',strtotime($bedtime)-900); ?></mark></center></td>
