...
<div class="content-body">
  ...
  <div class="container-fluid">
    <?php if($expiry_stat == 1):  ?>
      <div class="alert alert-info solid alert-dismissible fade show">
        <button type="button" class="close h-100" data-dismiss="alert" aria-label="Close"> <!--<span><i class="mdi mdi-close"></i></span> -->
        </button>For Purchase a Diet Plan  Click <a href="<?=base_url('plan_selection') ; ?>" class="badge badge-sm light badge-primary ml-1">here</a>
      </div>
      <?php elseif($expiry_stat == 2): ?>
        <div class="alert alert-warning solid alert-dismissible fade show">
            <button type="button" class="close h-100" data-dismiss="alert" aria-label="Close"> <!--<span><i class="mdi mdi-close"></i></span> -->
            </button> Your Plan Has been Expired ! Please renew now !! <a href="<?=base_url('plan_selection') ; ?>" class="badge badge-sm light badge-primary ml-1">Renew</a>
        </div>

    <?php elseif($expiry_stat == 3): ?>
      <div class="alert alert-info solid alert-dismissible fade show">
        <button type="button" class="close h-100" data-dismiss="alert" aria-label="Close"> <!--<span><i class="mdi mdi-close"></i></span> -->
        </button>Your plan is going to expire . Please renew Now <a href="<?=base_url('plan_selection') ; ?>" class="badge badge-sm light badge-primary ml-1">here</a>
    </div>
    <?php endif; ?>
                          ...
                          <?php if($todaysmealitems['morning_data']!=0){ ?>
                            ...
                            <div class="items">
                              <div class="card text-center">
                                <div class="card-body">
                                  <?php if(empty($fitem['food_image']) || $fitem['food_image'] =='' ){ ?>
                                  <img src="<?php echo base_url('assets/images/user/diet_plate.jpg') ; ?>" alt="">
                                  <?php }else{ ?>
                                    <img src="<?=base_url().$fitem['food_image'];?> " alt="">
                                    <?php } ?>
                                  <h5 class="fs-16 font-w500 mb-1"><a href="app-profile.html" class="text-black"><?=$fitem['quantity'].' ('.$fitem['unit'].') '.$fitem['food_name'] ?></a></h5>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="card-body pt-2">
                          ...
                          <?php if($todaysmealitems['breakfast_data']!=0){ ?>
                            <?php foreach($todaysmealitems['breakfast_data'] as $i=>$fitem){ ?>
                            <div class="items">
                              <div class="card text-center">
                                <div class="card-body">
                                  <?php if(empty($fitem['food_image']) || $fitem['food_image'] =='' ){ ?>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="card-body pt-2">
                          ...
                          <?php if($todaysmealitems['midmeal_data']!=''){ ?>
                            <?php foreach($todaysmealitems['midmeal_data'] as $i=>$fitem){ ?>
                            <div class="items">
                              <div class="card text-center">
                                <div class="card-body">
                                  <?php if(empty($fitem['food_image']) || $fitem['food_image'] =='' ){ ?>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="card-body pt-2">
                          ...
                          <?php if($todaysmealitems['lunch_data']!=0){ ?>
                            <?php foreach($todaysmealitems['lunch_data'] as $i=>$fitem){ ?>
                            <div class="items">
                              <div class="card text-center">
                                <div class="card-body">
                                  <?php if(empty($fitem['food_image']) || $fitem['food_image'] =='' ){ ?>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="card-body pt-2">
                          ...
                          <?php if($todaysmealitems['evening_data']!=''){ ?>
                            <?php foreach($todaysmealitems['evening_data'] as $i=>$fitem){ ?>
                            <div class="items">
                              <div class="card text-center">
                                <div class="card-body">
                                  <?php if(empty($fitem['food_image']) || $fitem['food_image'] =='' ){ ?>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="card-body pt-2">
                          ...
                          <?php if($todaysmealitems['dinnner_data']!=''){ ?>
                            <?php foreach($todaysmealitems['dinnner_data'] as $i=>$fitem){ ?>
                            <div class="items">
                              <div class="card text-center">
                                <div class="card-body">
                                  <?php if(empty($fitem['food_image']) || $fitem['food_image'] =='' ){ ?>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="card-body pt-2">
                          ...
                          <?php if($todaysmealitems['bedtime_data']!=''){ ?>
                            <?php foreach($todaysmealitems['bedtime_data'] as $i=>$fitem){ ?>
                            <div class="items">
                              <div class="card text-center">
                                <div class="card-body">
                                  <?php if(empty($fitem['food_image']) || $fitem['food_image'] =='' ){ ?>
      ...
      <div class="modal-body">
        <form method="post" action="<?=base_url();?>User/submitUserWeight">
          <div class="form-group">
            <input type="number" class="form-control" placeholder="Add weight (kg)" step="0.01"  name="weight"  min="30" max="160" onkeypress="javascript:return isNumber(event)" autocomplete="off" >
          </div>
