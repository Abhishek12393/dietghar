...
<link href="<?php echo base_url(); ?>dgassets/user/css/style.css" rel="stylesheet">
...
<img class="logo-abbr" src="<?php echo base_url(); ?>dgassets/user/images/logo.png" alt="">
<img class="logo-compact" src="<?php echo base_url(); ?>dgassets/user/images/logo-text.png" alt="">
<img class="brand-title" src="<?php echo base_url(); ?>dgassets/user/images/logo-text.png" alt="">
</a>
...
<div>
	<h6 class="mb-1">Chat with Admin 2</h6>
	<p class="mb-0 text-success" id="adminStat">Online</p>
...
<div class="img_cont_msg"><img src="<?php echo base_url(); ?>dgassets/user/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/></div>
<div class="msg_cotainer">Hi, how are you samim?<span class="msg_time">8:40 AM, Today</span></div>
</div>
<div class="d-flex justify-content-end mb-4">
<div class="msg_cotainer_send">Ok, thank you have a good day<span class="msg_time_send">9:10 AM, Today</span></div>
<div class="img_cont_msg"><img src="<?php echo base_url(); ?>dgassets/user/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/></div>
</div>
</div>
...
<img src="<?php echo base_url(); ?>dgassets/user/images/profile/17.jpg" width="20" alt=""/>
<div class="header-info">
<span class="text-black"><strong>Full Name</strong></span>
