...
<!-- Mirrored from themetechmount.com/html/nutricare/aboutus-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Apr 2020 08:09:29 GMT -->
<head>
<meta charset="utf-8">
...
<!-- responsive -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>wediet/assets/css/responsive.css"/>
...
<body>
                                                        ...
                                                        <div class="textwidget widget-text">
                                                            <div class="ttm-author-widget text-center ttm-textcolor-white">
                                                                <div class="author-widget_img">
                                                                    <img src="images/author-img.jpg" class="author-img" alt="author image">
                                                                </div>
                        ...
                        <div class="col-lg-3">
                            <div class="widget-left clearfix">
                                <div class="info-widget">
                                    <div class="info-widget-content"><p>24/7 Emergency Care</p><h2>+00 900 145 7890</h2> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                                ...
                                                <nav id="menu" class="menu">
                                                    <ul class="dropdown">
                                                        ...
                                                        <li class="active"><a href="#">Pages</a>
                                                            <ul>
                                                                <li class="active"><a href="aboutus-1.html">About Us 1</a></li>
                    ...
                    <div class="col-md-12 text-center"> 
                        <div class="title-box ttm-textcolor-white">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span><span class="ttm-textcolor-skincolor">About Us 1</span></span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
    ...
    <div class="site-main">
         <section class="ttm-row bg-img3 clearfix">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt_120 res-991-mt_50">
                            <!-- row -->
                            <div class="row">
                                <div class="blog-slide owl-carousel owl-theme owl-loaded" data-item="4" data-nav="false" data-dots="false" data-auto="true">
                                    <!-- featured-imagebox -->
                                    <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image">
                                        <div class="featured-thumbnail">
                                            <img class="img-fluid" src="<?php echo base_url(); ?>diet/assets/images/services-1.jpg" alt="Our Services">
                                        </div>
                                        <div class="ttm-box-bottom-content">
                                            ...
                                            <div class="featured-title featured-title">
                                                <h5><a href="#" tabindex="-1">Sports Nutritionist</a></h5>
                                            </div>
                                            <div class="featured-desc">
                                    ...
                                    <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image">
                                        <div class="featured-thumbnail">
                                            <img class="img-fluid" src="<?php echo base_url(); ?>diet/assets/images/services-2.jpg" alt="Our Services">
                                        </div>
                                        <div class="ttm-box-bottom-content">
                                            <div class="featured-icon">
                                                <div class="ttm-icon ttm-icon_element-fill ttm-icon_element-background-color-skincolor ttm-icon_element-size-md ttm-icon_element-style-rounded">
                                            ...
                                            <div class="featured-title featured-title">
                                                <h5><a href="#" tabindex="-1">Weight Loss Program</a></h5>
                                            </div>
                                            <div class="featured-desc">
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                                    ...
                                    <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image">
                                        <div class="featured-thumbnail">
                                            <img class="img-fluid" src="<?php echo base_url(); ?>diet/assets/images/services-3.jpg" alt="Our Services">
                                        </div>
                                        <div class="ttm-box-bottom-content">
                                            <div class="featured-icon">
                                                <div class="ttm-icon ttm-icon_element-fill ttm-icon_element-background-color-skincolor ttm-icon_element-size-md ttm-icon_element-style-rounded">
                                            ...
                                            <div class="featured-title featured-title">
                                                <h5><a href="#" tabindex="-1">Healthy Breakfast</a></h5>
                                            </div>
                                            <div class="featured-desc">
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                                            </div>
                                    ...
                                    <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image">
                                        <div class="featured-thumbnail">
                                            <img class="img-fluid" src="<?php echo base_url(); ?>diet/assets/images/services-4.jpg" alt="Our Services">
                                        </div>
                                        <div class="ttm-box-bottom-content">
                                            <div class="featured-icon">
                                                <div class="ttm-icon ttm-icon_element-fill ttm-icon_element-background-color-skincolor ttm-icon_element-size-md ttm-icon_element-style-rounded">
                                                    <i class="flaticon flaticon-healthy"></i>
                                                </div>
                                            </div>
                                            <div class="featured-title featured-title">
                                                <h5><a href="#" tabindex="-1">Healthy Meal</a></h5>
                                            </div>
                                            <div class="featured-desc">
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                                            </div>
            ...
            <!-- gallery-plan-section -->
            <section class="gallery-plan-section clearfix ">
                <div class="container">
                    <!-- row -->
                    <div class="row ">
                        <div class="col-md-12 ">
                            ...
                            <div class="section-title text-center clearfix ">
                                <div class="title-header ">
                                    <h5>Way to get fit</h5>
                                    <h2 class="title ">Steps to your perfect body</h2>
                                </div>
                            </div>
                            <!-- section title end -->
                        </div>
                    ...
                    <div class="row ">
                        <div class="wrap-team team-slide ttm-boxes-spacing-10px owl-carousel owl-theme owl-loaded" data-item="1" data-nav="true" data-dots="true " data-auto="true">
                            <div class="item">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="fitBodySection text-center">
                                            ...
                                            <div class="product-desc">
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor, illum iusto similique aliquam, expedita dicta voluptatibus nulla rerum, culpa maxime neque necessitatibus. Nulla distinctio laboriosam commodi,
                                                    explicabo error natus est?</p>
                                                <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-round  ttm-btn-style-border ttm-btn-color-white mb-20" href="#">View More</a>
                                            </div>
                                            <!--./product-desc-->
                                        </div>
                                        <!--./fitBodySection-->
            ...
            <!-- gallery-plan-section end -->


        <!-- about-blog-section -->
        <section class="ttm-row about-blog-section ttm-bgcolor-grey clearfix">
            <div class="container">
                <!-- row -->
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="blog-slide owl-carousel owl-theme owl-loaded" data-item="3" data-nav="false" data-dots="false" data-auto="true">
                        ...
                        <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image mt-40">
                            <div class="ttm-box-bottom-content">
                                ...
                                <div class="featured-title featured-title">
                                    <h5><a href="sports-nutritionist.html" tabindex="-1">Sports Nutritionist</a></h5>
                                </div>
                                <div class="featured-desc">
                                    <p>We are specializing in sports nutrition. Our sports nutrition team love the benefits of exercise brings. </p>
                                    <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-black btn-inline ttm-btn-underline pt-3" href="sports-nutritionist.html">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image mt-40">
                            <div class="ttm-box-bottom-content">
                                ...
                                <div class="featured-title featured-title">
                                    <h5><a href="personalized-nutrition.html" tabindex="-1">Personalized Nutrition</a></h5>
                                </div>
                                <div class="featured-desc">
                                    <p>Our personalized nutrition foods are right for you &amp; supplements should be taking with diet plan.</p>
                                    <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-black btn-inline ttm-btn-underline pt-3" href="personalized-nutrition.html">Read More</a>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                        <!-- featured-imagebox -->
                        <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image mt-40">
                            <div class="ttm-box-bottom-content">
                                ...
                                <div class="featured-title featured-title">
                                    <h5><a href="weight-loss-programs.html" tabindex="-1">Weight Loss Programs</a></h5>
                                </div>
                                <div class="featured-desc">
                                    <p>Weight loss process doesn’t mean strive to body but make the eating process healthy and fully exotic.</p>
                                    <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-black btn-inline ttm-btn-underline pt-3" href="weight-loss-programs.html">Read More</a>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                        <!-- featured-imagebox -->
                        <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image mt-40">
                            <div class="ttm-box-bottom-content">
                                ...
                                <div class="featured-title featured-title">
                                    <h5><a href="individual-coaching.html" tabindex="-1">Individual Coaching</a></h5>
                                </div>
                                <div class="featured-desc">
                                    <p>We provide air conditioning service, repair maintenance support 24/7, delivered by qualified service engineers.</p>
                                    <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-black btn-inline ttm-btn-underline pt-3" href="individual-coaching.html">Read More</a>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                        <!-- featured-imagebox -->
                        <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image mt-40">
                            <div class="ttm-box-bottom-content">
                                ...
                                <div class="featured-title featured-title">
                                    <h5><a href="child-nutrition.html" tabindex="-1">Child Nutrition</a></h5>
                                </div>
                                <div class="featured-desc">
                                    <p>Our main goal for the child nutrition is to provide a healthy and nutritious breakfast to child for better health.</p>
                                    <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-black btn-inline ttm-btn-underline pt-3" href="child-nutrition.html">Read More</a>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                        <!-- featured-imagebox -->
                        <div class="featured-imagebox featured-imagebox-service ttm-box-view-top-image mt-40">
                            <div class="ttm-box-bottom-content">
                                ...
                                <div class="featured-title featured-title">
                                    <h5><a href="child-nutrition.html" tabindex="-1">Workout Routines</a></h5>
                                </div>
                                <div class="featured-desc">
                                    <p>Our main goal for the child nutrition is to provide a healthy and nutritious breakfast to child for better health.</p>
                                    <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-black btn-inline ttm-btn-underline pt-3" href="workout-routines.html">Read More</a>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                    </div>
        ...
        <!-- our-team-section -->
        <section class="ttm-row about-our-team-section ttm-bgcolor-skincolor clearfix">
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="section-title text-center clearfix">
                            ...
                            <div class="title-desc">
                                <P>We plan different activities to cheer up our clients. Consistency may make <br> them bore, possibly treatment might not work 100%.
                                </P>
                            </div>
                        </div><!-- section title end -->
                    </div>
                ...
                <div class="row">
                    <div class="wrap-team  team-slide ttm-boxes-spacing-5px owl-carousel owl-theme owl-loaded" data-item="5" data-nav="false" data-dots="false" data-auto="false">
                        <!-- featured-imagebox -->
                            ...
                            <div class="ttm-box-view-overlay ttm-team-box-view-overlay">
                                ...
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title"><!-- team-member-name -->
                                        <h5><a href="team-details.html">Sara Tailor</a></h5>
                                    </div>
                                    <div class="ttm-team-position ttm-textcolor-white">General Nutrition</div><!-- team-member-position -->
                        ...
                        <div class="featured-imagebox featured-imagebox-team box-shadow1">
                            <div class="ttm-box-view-overlay ttm-team-box-view-overlay">
                                <div class="featured-thumbnail"><!-- team-member-image -->
                                    <img class="img-fluid" src="images/team-member/team-img02.jpg" alt="">
                                </div>
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title"><!-- team-member-name -->
                                        <h5><a href="team-details.html">Steave Martin</a></h5>
                                    </div>
                                    <div class="ttm-team-position ttm-textcolor-white">General Nutrition</div><!-- team-member-position -->
                                    <div class="ttm-social-links-wrapper">
                                        <ul class="social-icons list-inline">
                        ...
                        <div class="featured-imagebox featured-imagebox-team box-shadow1">
                            <div class="ttm-box-view-overlay ttm-team-box-view-overlay">
                                <div class="featured-thumbnail"><!-- team-member-image -->
                                    <img class="img-fluid" src="images/team-member/team-img03.jpg" alt="">
                                </div>
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title"><!-- team-member-name -->
                                        <h5><a href="team-details.html">Alena Joh</a></h5>
                                    </div>
                                    <div class="ttm-team-position ttm-textcolor-white">General Nutrition</div><!-- team-member-position -->
                                    <div class="ttm-social-links-wrapper">
                                        <ul class="social-icons list-inline">
                        ...
                        <div class="featured-imagebox featured-imagebox-team box-shadow1">
                            <div class="ttm-box-view-overlay ttm-team-box-view-overlay">
                                <div class="featured-thumbnail"><!-- team-member-image -->
                                    <img class="img-fluid" src="images/team-member/team-img04.jpg" alt="">
                                </div>
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title"><!-- team-member-name -->
                                        <h5><a href="team-details.html">Serna Viktor</a></h5>
                                    </div>
                                    <div class="ttm-team-position ttm-textcolor-white">General Nutrition</div><!-- team-member-position -->
                                    <div class="ttm-social-links-wrapper">
                                        <ul class="social-icons list-inline">
                        ...
                        <div class="featured-imagebox featured-imagebox-team box-shadow1">
                            <div class="ttm-box-view-overlay ttm-team-box-view-overlay">
                                <div class="featured-thumbnail"><!-- team-member-image -->
                                    <img class="img-fluid" src="images/team-member/team-img05.jpg" alt="">
                                </div>
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title"><!-- team-member-name -->
                                        <h5><a href="team-details.html">John advoc</a></h5>
                                    </div>
                                    <div class="ttm-team-position ttm-textcolor-white">General Nutrition</div><!-- team-member-position -->
                                    <div class="ttm-social-links-wrapper">
                                        <ul class="social-icons list-inline">
                        ...
                        <div class="featured-imagebox featured-imagebox-team box-shadow1">
                            <div class="ttm-box-view-overlay ttm-team-box-view-overlay">
                                ...
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title"><!-- team-member-name -->
                                        <h5><a href="team-details.html">David Hobs</a></h5>
                                    </div>
                                    <div class="ttm-team-position ttm-textcolor-white">General Nutrition</div><!-- team-member-position -->
                                    <div class="ttm-social-links-wrapper">
                                        <ul class="social-icons list-inline">
                        ...
                        <div class="featured-imagebox featured-imagebox-team box-shadow1">
                            <div class="ttm-box-view-overlay ttm-team-box-view-overlay">
                                <div class="featured-thumbnail"><!-- team-member-image -->
                                    <img class="img-fluid" src="images/team-member/team-img07.jpg" alt="">
                                </div>
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title"><!-- team-member-name -->
                                        <h5><a href="team-details.html">Evan Carlo</a></h5>
                                    </div>
                                    <div class="ttm-team-position ttm-textcolor-white">General Nutrition</div><!-- team-member-position -->
                                    <div class="ttm-social-links-wrapper">
                                        <ul class="social-icons list-inline">
                ...
                <div class="row pt-35 res-991-pt-20">
                    <div class="col-md-12 text-center mb-20">
                        <p>Don’t hesitate, contact us for better help and services.<u class="ttm-textcolor-black"><a href="#"> Explore More Team</a></u></p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="section-title text-center clearfix">
                            ...
                            <div class="title-desc">
                                <p>Your body believes what you think, your thought becomes action, Action becomes behavior so keep your Positive attitude alive!.
                                </p>
                            </div>
                        </div><!-- section title end -->
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ttm-processbox-wrapper">
                            <div class="ttm-processbox">
                                ...
                                <div class="featured-content">
                                    <div class="featured-title"><h5>Trusted Services</h5></div>
                                    <div class="ttm-box-description">Diet is not striving but Eating well-balanced food.</div>
                                </div>
                            </div>
                            <div class="ttm-processbox">
                                <div class="ttm-box-image">
                                ...
                                <div class="featured-content">
                                    <div class="featured-title"><h5>Go Natural</h5></div>
                                    <div class="ttm-box-description">Is about encouraging people to go back to nature.</div>
                                </div>
                            </div>
                            <div class="ttm-processbox">
                                <div class="ttm-box-image">
                                ...
                                <div class="featured-content">
                                    <div class="featured-title"><h5>Schedule Exercise</h5></div>
                                    <div class="ttm-box-description">To live well and live longer, you must be exercise!</div>
                                </div>
                            </div>
                            <div class="ttm-processbox">
                                <div class="ttm-box-image">
                                ...
                                <div class="featured-content">
                                    <div class="featured-title"><h5>Celebrate Success</h5></div>
                                    <div class="ttm-box-description">Always appreciate what you have, celebrate it!</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                        <div class="widget widget_text clearfix">
                           ...
                           <ul class="widget-post ttm-recent-post-list">
                                <li>
                                    <a href="single-blog.html"><img src="images/blog/post-1.jpg" alt="post-img"></a>
                                ...
                                <li>
                                    <a href="single-blog.html"><img src="images/blog/post-2.jpg" alt="post-img"></a>
                                ...
                                <li>
                                    <a href="single-blog.html"><img src="images/blog/post-3.jpg" alt="post-img"></a>
    ...
    <script src="<?php echo base_url(); ?>diet/assets/js/jquery.min.js"></script>
    <script src="<?php echo base_url(); ?>diet/assets/js/tether.min.js"></script>
    <script src="<?php echo base_url(); ?>diet/assets/js/bootstrap.min.js"></script> 
    <script src="<?php echo base_url(); ?>diet/assets/js/jquery.easing.js"></script>    
    <script src="<?php echo base_url(); ?>diet/assets/js/jquery-waypoints.js"></script>    
    <script src="<?php echo base_url(); ?>diet/assets/js/owl.carousel.js"></script>
    <script src="<?php echo base_url(); ?>diet/assets/js/jquery.prettyPhoto.js"></script>
    <script src="<?php echo base_url(); ?>diet/assets/js/numinate.min6959.js?ver=4.9.3"></script>
...
<!-- Mirrored from themetechmount.com/html/nutricare/aboutus-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Apr 2020 08:09:36 GMT -->
</html>