...
<body style="overflow-x: hidden;">
	<div class="container">
		<div class="row">
			<h2 class="text-center">7 Meal Plan ----Accepted Diet-(<?=$count?>) --Decline (<?=$count_decline?>)----Remaining (<?=$count_remaining?>)</h2>
      <form method="post" action="<?=base_url('Admin/submitAllmeal')?>">
...
<div class="text-center">
		<input type="submit" name="Accept" value="Accept" class="btn btn-success" style="margin: 10px;height: 40px;font-size: 16px;">
  </div>
		</form>
		</div>
      ...
      <div class="col-md-3">
        <form method="post" action="<?=base_url('Admin/rejectMeal')?>">
          ...
          <input type="hidden" name="chart_id" value="<?=$message[0]['fake_chart_id']?>">
        <input type="submit" name="Reject" value="Reject" class="btn btn-danger" style="margin: 10px;height: 40px;font-size: 16px;margin-top: -43%;padding-left: 10px;margin-left: 15%;">
      </form>
      </div>
			<div class="col-md-1">
