...
<div class="content-wrapper">
	...
	<?php endif; ?>
		<a href="<?=base_url();?>/cron_ci/log/sevenmealBreakdownCron.json">Breakdown Cron View</a>
		<!-- Hover rows -->
		<div class="card">
			<div class="card-header header-elements-inline">
				<h5 class="card-title">Table view - breakdown table</h5>
							...
							<tr>
						 	 ...
						 	 ?>
								...
								<td style="width: 9%">
									...
									<td style="width:5%;">
									<form action="<?=base_url();?>DBManager/dayShift_frombreakdown" method="POST" target="_parent">
										<input type="hidden" name="totalcal" value="<?=$row['totalcalories']?>">
										<input type="hidden" name="fromtable" value="<?='final_chart_1_breakdown';?>">
										<input type="hidden" name="fromUniqId" value="<?=$row['uniq_id']?>">
