...
<select class="food select2x" style="width: 100% !important;">
<?php
...
<script src="<?php echo base_url(); ?>admin/assets/functions/type.js"></script>
<script src="<?php echo base_url(); ?>admin/assets/functions/typesub.js"></script>
<script src="<?php echo base_url(); ?>admin/assets/functions/city.js"></script>

<select name="<?=$day?>_<?=$name?>_data_food[]" id="<?=$name?>_fod_data_<?=$value1['foodId']?>" id='selUser'style="width: 100% !important;" onClick="showtype(this.value)">
<option value="<?=$value1['id']?>" ><?=$value1['food_name']?></option> 
</select>

<div id="Type" id='selUser' style="border-color:red !important;"></div>
...
?>
<br />
<center><a href="javascript:void(0);" class="btn btn-primary passenger_morning" type="<?=$day?>">Add More</a></center>
</td>
<?php } ?>
<?php if(in_array('Breakfast',$_POST['Placement']))
{ ?>
...
?>
<br />
<center><a href="javascript:void(0);" class="btn btn-primary passenger_breakfast"  type="<?=$day?>">Add More</a></center>
</td>
<?php } ?>
<?php if(in_array('Mid Meal',$_POST['Placement']))
{ ?>
...
?>
<br />
<center><a href="javascript:void(0);" class="btn btn-primary passenger_midmeal"  type="<?=$day?>">Add More</a></center>
</td>
<?php } ?>
<?php if(in_array('Lunch',$_POST['Placement'])) { ?>
...
?>
<br />
<center><a href="javascript:void(0);" class="btn btn-primary passenger"  type="<?=$day?>">Add More</a></center>
</td>
<?php } ?>
<?php if(in_array('Evening Snack',$_POST['Placement'])) { ?>
...
?>
<br />
<center><a href="javascript:void(0);" class="btn btn-primary passenger_evening"  type="<?=$day?>">Add More</a></center>
</td>
<?php } ?>
<?php if(in_array('Dinner',$_POST['Placement'])) { ?>
...
?>
<br />
<center><a href="javascript:void(0);" class="btn btn-primary passenger_dinner"  type="<?=$day?>">Add More</a></center>
</td>
<?php } ?>
<?php if(in_array('Bed Time',$_POST['Placement']))
{ ?>
...
?>
<br />
<center><a href="javascript:void(0);" class="btn btn-primary passenger_bedtime" type="<?=$day?>">Add More</a></center>
</td>
<?php } ?>
<td style="width: 12%">
