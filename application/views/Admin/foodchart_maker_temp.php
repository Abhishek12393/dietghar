...
<?php
	...
	foreach ($value['morning_data'] as $key => $value1) { ?> 
		...
		<input type="hidden" name="<?=$day?>_<?=$name?>_data_food2[]" value="<?=$value1['foodId']; ?>">
		<input type="text"  class="" id="<?=$name?>_food_data_<?=$value1['foodId']?>_<?=$day?>" name="<?=$day?>_<?=$name?>_data_food[]"  value='<?= $value1['food_name']; ?>' data-id="<?=$value1['foodId']; ?>" data-quant="<?=$name?>_food_quan_<?=$value1['foodId']?>_<?=$day?>" data-day="<?=$day?>" data-shift="<?=$name?>" data-iItemCount="<?=$iItemCount?>"  data-addmore="1">
					...
					<strong class="">
						<span>
							...
							foreach ($value['breakfast_data'] as $key => $value1) {
								...
								<span id="<?=$name?>_d_fibrespan_<?=$day?>_i<?=$iItemCount?>" class="<?=$name?>_<?=$day?>_d_fibre" style="display:none;"><?php echo  $value1["d_fibre"]*$value1["quantity"] ?></span>
								<?php 
								$box_calo += ($value1['quantity']*$value1['calories']);
								$box_pro += ($value1['quantity']*$value1['protein']);
								$box_fat += ($value1['quantity']*$value1['fat']);
					...
					<strong class="">
						<span >
							...
							// echo $name;
								...
								<!-- New buttons AT-->
									<input type="float" readonly  name="<?=$day?>_<?=$name?>_data_quantity[]" value="<?=$value1['quantity']; ?>" id="<?=$name?>_food_quan_<?=$value1['foodId']?>_<?=$day?>">
									<input type="hidden" name="<?=$day?>_<?=$name?>_data_food2[]" value="<?=$value1['foodId']; ?>"><!--to post id  -->
									<input type="text"  class="" id="<?=$name?>_food_data_<?=$value1['foodId']?>_<?=$day?>" name="<?=$day?>_<?=$name?>_data_food[]"  value='<?= $value1['food_name']; ?>' data-id="<?=$value1['foodId']; ?>" data-quant="<?=$name?>_food_quan_<?=$value1['foodId']?>_<?=$day?>" data-day="<?=$day?>" data-shift="<?=$name?>" data-iItemCount="<?=$iItemCount?>" data-addmore="1">
...
<script>
	// add more
 	function addmore(shift,day,count){
 		...
 		var e1 = " <input readonly type='float' id='food_quan_"+shift+"_"+day+"_"+count+"' name='' value=''>";
