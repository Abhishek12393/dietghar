...
<img id="logo-img" class="img-center" src="http://dietghar.in/diet/diet/assets/images/logo-diet.png" alt="logo-img">
</a></center>
</div>
</div>
</div>
...
<form method="Post" action="<?=base_url()?>Stepper/payment_mode">
<input type="hidden" name="amount" value="599">
<input type="hidden" name="plan" value="Diet Essential Plan">
...
<h1 class="price-price-title"> <i class="fa fa-rupee"></i> 599 </h1>
...
<input type="hidden" name="plan" value="Diet Pro Plan">
<div class="pricing-list-frist-1 frist-r">                                
<div class="set-6547979798798798">
<h4 class="name-price"> Diet Advanced </h4>
<h1 class="price-price-title1"> <i class="fa fa-rupee"></i> 1100 </h1>
