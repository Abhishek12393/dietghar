        ...
        <div class="card-body d-flex flex-column gap-2 align-items-center justify-content-center">
            ...
            <div class="row gy-3 align-items-center justify-content-center">
                <div class="inputs d-flex flex-row justify-content-center mt-2">
                    ...
                    <input type="text" class="form-control text-capitalize" id="i7" onkeyup="lastname(event)" onkeypress="return (event.charCode > 64 &&  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123 || event.charCode==13)"  autocomplete="off" required/>
                </div>
            </div>
