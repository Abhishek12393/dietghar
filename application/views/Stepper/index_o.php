      ...
      <div class="row justify-content-md-center" >
        <div class="col col-lg-8" style="margin-top:-30px;">
          ...
          <div class="main-otp-section" id="otp" style="margin-top:-20px;">
            ...
            <input id="f1"  class="inputs" type="number" maxlength="1" required autocomplete="off">
            <input id="f2"  class="inputs" type="number" maxlength="1" required autocomplete="off">
            <input id="f3"  class="inputs" type="number" maxlength="1" required autocomplete="off">
            <input id="f4" class="inputs" type="number" maxlength="1" required autocomplete="off">
            <input id="f5"  class="inputs" type="number" maxlength="1" required autocomplete="off">
            <input id="last" onkeyup="stepper_2(event);" class="inputs"  type="number" maxlength="1" required autocomplete="off">
...
function sendotp(event){
  ...
  // function checkkeycode2(event){
  //   span.innerHTML = '2=> '+event.keyCode;
  // }
</script>
<script>
...
*/
otpfields.addEventListener('textInput', function(e) {
  if (this.value.length == this.maxLength) {
    var char = e.data; // In our example = "a"
